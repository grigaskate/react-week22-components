...
function App() {
  return (
    <div className="App">
      ...
      <Superhero name={superhero.name} universe={superhero.universe} alterego={superhero.alterego} 
      occupation={superhero.occupation} friends={superhero.friends} superpowers={superhero.superpowers}
      url={superhero.url} info={superhero.info}></Superhero>)
      }
    </div>
  );
}
